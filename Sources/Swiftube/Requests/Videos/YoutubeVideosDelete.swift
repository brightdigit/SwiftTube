...
public extension Videos {
  ...
  enum YoutubeVideosDelete {
    public static let service = APIService<Response>(id: "youtube.videos.delete", tag: "videos", method: "DELETE", path: "/youtube/v3/videos", hasBody: false, securityRequirements: [SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtubepartner"])])
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeVideosDelete.service)
      }
