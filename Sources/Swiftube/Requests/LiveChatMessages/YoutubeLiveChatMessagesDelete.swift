  ...
  enum YoutubeLiveChatMessagesDelete {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeLiveChatMessagesDelete.service)
      }
