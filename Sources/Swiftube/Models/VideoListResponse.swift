...
public struct VideoListResponse: Model {
  ...
  public init(etag: String? = nil, eventId: String? = nil, items: [Video]? = nil, kind: String? = nil, nextPageToken: String? = nil, pageInfo: PageInfo? = nil, prevPageToken: String? = nil, tokenPagination: TokenPagination? = nil, visitorId: String? = nil) {
    self.etag = etag
