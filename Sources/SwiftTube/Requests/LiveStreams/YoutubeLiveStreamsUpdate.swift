...
public extension LiveStreams {
  ...
  enum YoutubeLiveStreamsUpdate {
    public static let service = APIService<Response>(id: "youtube.liveStreams.update", tag: "liveStreams", method: "PUT", path: "/youtube/v3/liveStreams", hasBody: true, securityRequirements: [SecurityRequirement(type: "Oauth2c", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2c", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"])])
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(body: LiveStream?, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: YoutubeLiveStreamsUpdate.service) { defaultEncoder in
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(LiveStream.self, from: data))
