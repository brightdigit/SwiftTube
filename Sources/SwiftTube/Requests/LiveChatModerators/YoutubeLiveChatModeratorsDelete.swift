  ...
  enum YoutubeLiveChatModeratorsDelete {
    ...
    public final class Request: APIRequest<Response, YouTube.API> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeLiveChatModeratorsDelete.service)
      }
