...
public extension LiveChatModerators {
  ...
  enum YoutubeLiveChatModeratorsInsert {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public var body: LiveChatModerator?

      public init(body: LiveChatModerator?, options: Options, encoder: RequestEncoder? = nil) {
        self.body = body
        self.options = options
        super.init(service: YoutubeLiveChatModeratorsInsert.service) { defaultEncoder in
          try (encoder ?? defaultEncoder).encode(body)
        }
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], body: LiveChatModerator? = nil) {
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      public typealias SuccessType = LiveChatModerator

      /** Successful response */
      case status200(LiveChatModerator)

      public var success: LiveChatModerator? {
        switch self {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(LiveChatModerator.self, from: data))
