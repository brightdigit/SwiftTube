...
public extension ChannelSections {
  ...
  enum YoutubeChannelSectionsList {
    ...
    public final class Request: APIRequest<Response, YouTube.API> {
      public struct Options {
        ...
        public init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], channelId: String? = nil, hl: String? = nil, id: [String]? = nil, mine: Bool? = nil, onBehalfOfContentOwner: String? = nil) {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeChannelSectionsList.service)
      }
      ...
      public convenience init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], channelId: String? = nil, hl: String? = nil, id: [String]? = nil, mine: Bool? = nil, onBehalfOfContentOwner: String? = nil) {
        let options = Options(dollarXgafv: dollarXgafv, accessToken: accessToken, alt: alt, callback: callback, fields: fields, key: key, oauthToken: oauthToken, prettyPrint: prettyPrint, quotaUser: quotaUser, uploadProtocol: uploadProtocol, uploadType: uploadType, part: part, channelId: channelId, hl: hl, id: id, mine: mine, onBehalfOfContentOwner: onBehalfOfContentOwner)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public typealias SuccessType = ChannelSectionListResponse

      /** Successful response */
      case status200(ChannelSectionListResponse)

      public var success: ChannelSectionListResponse? {
        switch self {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(ChannelSectionListResponse.self, from: data))
