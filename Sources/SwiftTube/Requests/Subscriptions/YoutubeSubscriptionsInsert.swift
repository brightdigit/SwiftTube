  ...
  enum YoutubeSubscriptionsInsert {
    ...
    public struct Request: ServiceRequest {
      ...
      public var service: Service<Response> {
        YoutubeSubscriptionsInsert.service
      }
      ...
      public init(body: Subscription?, options: Options, encoder _: RequestEncoder? = nil) {
        self.body = body
        self.options = options
      }

      /// convenience initialiser so an Option doesn't have to be created
      public init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], body: Subscription? = nil) {
