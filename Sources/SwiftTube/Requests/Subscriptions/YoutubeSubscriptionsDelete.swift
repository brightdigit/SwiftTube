...
public extension Subscriptions {
  ...
  enum YoutubeSubscriptionsDelete {
    public static let service = APIService<Response>(id: "youtube.subscriptions.delete", tag: "subscriptions", method: "DELETE", path: "/youtube/v3/subscriptions", hasBody: false, securityRequirements: [SecurityRequirement(type: "Oauth2c", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2c", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"]), SecurityRequirement(type: "Oauth2c", scopes: ["https://www.googleapis.com/auth/youtubepartner"])])
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeSubscriptionsDelete.service)
      }
