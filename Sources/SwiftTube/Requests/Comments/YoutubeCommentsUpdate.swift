...
public extension Comments {
  ...
  enum YoutubeCommentsUpdate {
    public static let service = Service<Response>(id: "youtube.comments.update", tag: "comments", method: "PUT", path: "/youtube/v3/comments", hasBody: true, securityRequirements: [SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"])])
    ...
    public final class Request: DeprecatedRequest<Response, YouTube.API> {
      ...
      public init(body: Comment?, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: YoutubeCommentsUpdate.service) { defaultEncoder in
