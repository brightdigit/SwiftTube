...
public extension Tests {
  ...
  enum YoutubeTestsInsert {
    ...
    public final class Request: DeprecatedRequest<Response, YouTube.API> {
      ...
      public var body: TestItem?

      public init(body: TestItem?, options: Options, encoder: RequestEncoder? = nil) {
        self.body = body
        self.options = options
        super.init(service: YoutubeTestsInsert.service) { defaultEncoder in
          try (encoder ?? defaultEncoder).encode(body)
        }
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], body: TestItem? = nil) {
    ...
    public enum Response: DeprecatedResponse, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      /** Successful response */
      case status200(TestItem)

      public var success: TestItem? {
        switch self {
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(TestItem.self, from: data))
