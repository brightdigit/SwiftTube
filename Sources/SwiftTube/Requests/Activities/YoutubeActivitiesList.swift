...
public extension Activities {
  ...
  enum YoutubeActivitiesList {
    public static let service = Service<Response>(id: "youtube.activities.list", tag: "activities", method: "GET", path: "/youtube/v3/activities", hasBody: false, securityRequirements: [SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.readonly"])])

    public struct Request: ServiceRequest {
      public typealias ResponseType = Response

      public var service: Service<Response> {
        YoutubeActivitiesList.service
      }
