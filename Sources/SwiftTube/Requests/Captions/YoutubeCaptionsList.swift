  ...
  enum YoutubeCaptionsList {
    ...
    public final class Request: APIRequest<Response, YouTube.API> {
      public struct Options {
        ...
        public init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], videoId: String, id: [String]? = nil, onBehalfOf: String? = nil, onBehalfOfContentOwner: String? = nil) {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeCaptionsList.service)
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], videoId: String, id: [String]? = nil, onBehalfOf: String? = nil, onBehalfOfContentOwner: String? = nil) {
        let options = Options(dollarXgafv: dollarXgafv, accessToken: accessToken, alt: alt, callback: callback, fields: fields, key: key, oauthToken: oauthToken, prettyPrint: prettyPrint, quotaUser: quotaUser, uploadProtocol: uploadProtocol, uploadType: uploadType, part: part, videoId: videoId, id: id, onBehalfOf: onBehalfOf, onBehalfOfContentOwner: onBehalfOfContentOwner)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public typealias SuccessType = CaptionListResponse
      ...
      public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
        switch statusCode {
        case 200: self = try .status200(decoder.decode(CaptionListResponse.self, from: data))
