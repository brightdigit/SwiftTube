...
public extension ThirdPartyLinks {
  ...
  enum YoutubeThirdPartyLinksInsert {
    public static let service = APIService<Response>(id: "youtube.thirdPartyLinks.insert", tag: "thirdPartyLinks", method: "POST", path: "/youtube/v3/thirdPartyLinks", hasBody: true, securityRequirements: [])
