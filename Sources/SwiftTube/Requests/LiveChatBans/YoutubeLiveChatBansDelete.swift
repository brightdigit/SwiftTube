  ...
  enum YoutubeLiveChatBansDelete {
    ...
    public final class Request: DeprecatedRequest<Response, YouTube.API> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeLiveChatBansDelete.service)
      }
