  ...
  enum YoutubeYoutubeV3UpdateCommentThreads {
    ...
    public struct Request: ServiceRequest {
      ...
      public var service: Service<Response> {
        YoutubeYoutubeV3UpdateCommentThreads.service
      }
      ...
      public init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String]? = nil, body: CommentThread? = nil) {
