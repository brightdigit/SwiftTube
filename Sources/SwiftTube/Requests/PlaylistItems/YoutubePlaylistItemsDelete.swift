...
public extension PlaylistItems {
  ...
  enum YoutubePlaylistItemsDelete {
    public static let service = APIService<Response>(id: "youtube.playlistItems.delete", tag: "playlistItems", method: "DELETE", path: "/youtube/v3/playlistItems", hasBody: false, securityRequirements: [SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtubepartner"])])
    ...
    public final class Request: APIRequest<Response, YouTube.API> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubePlaylistItemsDelete.service)
      }
