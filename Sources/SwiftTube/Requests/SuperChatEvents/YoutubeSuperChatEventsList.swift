...
public extension SuperChatEvents {
  ...
  enum YoutubeSuperChatEventsList {
    public static let service = APIService<Response>(id: "youtube.superChatEvents.list", tag: "superChatEvents", method: "GET", path: "/youtube/v3/superChatEvents", hasBody: false, securityRequirements: [SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.readonly"])])
    ...
    public final class Request: APIRequest<Response, YouTube.API> {
      ...
      public init(options: Options) {
        ...
        super.init(service: YoutubeSuperChatEventsList.service)
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], hl: String? = nil, maxResults: Int? = nil, pageToken: String? = nil) {
