...
public extension Videos {
  ...
  enum YoutubeVideosUpdate {
    public static let service = APIService<Response>(id: "youtube.videos.update", tag: "videos", method: "PUT", path: "/youtube/v3/videos", hasBody: true, securityRequirements: [SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"]), SecurityRequirement(type: "Oauth2", scopes: ["https://www.googleapis.com/auth/youtubepartner"])])
    ...
    public final class Request: APIRequest<Response, YouTube.API> {
      ...
      public init(body: Video?, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: YoutubeVideosUpdate.service) { defaultEncoder in
