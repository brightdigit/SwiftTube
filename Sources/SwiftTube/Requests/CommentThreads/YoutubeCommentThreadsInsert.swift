...
public extension CommentThreads {
  ...
  enum YoutubeCommentThreadsInsert {
    public static let service = Service<Response>(id: "youtube.commentThreads.insert", tag: "commentThreads", method: "POST", path: "/youtube/v3/commentThreads", hasBody: true, securityRequirements: [SecurityRequirement(type: "Oauth2c", scopes: ["https://www.googleapis.com/auth/youtube.force-ssl"])])
    ...
    public final class Request: DeprecatedRequest<Response, YouTube.API> {
      ...
      public var body: CommentThread?

      public init(body: CommentThread?, options: Options, encoder: RequestEncoder? = nil) {
        self.body = body
        self.options = options
        super.init(service: YoutubeCommentThreadsInsert.service) { defaultEncoder in
          try (encoder ?? defaultEncoder).encode(body)
        }
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(dollarXgafv: Xgafv? = nil, accessToken: String? = nil, alt: Alt? = nil, callback: String? = nil, fields: String? = nil, key: String? = nil, oauthToken: String? = nil, prettyPrint: Bool? = nil, quotaUser: String? = nil, uploadProtocol: String? = nil, uploadType: String? = nil, part: [String], body: CommentThread? = nil) {
