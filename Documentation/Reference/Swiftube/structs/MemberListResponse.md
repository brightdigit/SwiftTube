...
```swift
public struct MemberListResponse: Model
```
...
```swift
public init(etag: String? = nil, eventId: String? = nil, items: [Member]? = nil, kind: String? = nil, nextPageToken: String? = nil, pageInfo: PageInfo? = nil, tokenPagination: TokenPagination? = nil, visitorId: String? = nil)
```
