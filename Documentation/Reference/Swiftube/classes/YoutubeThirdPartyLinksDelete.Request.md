...
# `YoutubeThirdPartyLinksDelete.Request`
...
### `init(dollarXgafv:accessToken:alt:callback:fields:key:oauthToken:prettyPrint:quotaUser:uploadProtocol:uploadType:linkingToken:type:part:)`
